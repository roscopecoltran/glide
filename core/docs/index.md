...
2. Download a [versioned release](https://github.com/roscopecoltran/glide/core/releases). Glide releases are semantically versioned.
...
4. The latest development snapshot can be installed with `go get`. For example, `go get -u github.com/roscopecoltran/glide`. This is not a release version.
